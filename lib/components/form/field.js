...
function Field(_a) {
    ...
    if (type === 'radio' || type === 'checkbox') {
        return (_jsxs(StyledField, { children: [children({ input: input, meta: meta }), meta.error && _jsx(Error, { children: meta.error })] }));
    }
    return (_jsxs(StyledField, { children: [!!label && (_jsxs(StyledLabel, __assign({ htmlFor: name }, { children: [label, !required && ' (Optional)'] }))), children({ input: input, meta: meta }), meta.error && meta.touched && _jsx(Error, { children: meta.error })] }));
}
