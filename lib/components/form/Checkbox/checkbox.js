...
var Checkbox = function (_a) {
    ...
    return (_jsx(Field, __assign({}, restProps, { children: function (_a) {
            var input = _a.input;
            return (_jsxs("div", __assign({ style: { marginBottom: '15px' } }, { children: [_jsx(StyledCheckbox, __assign({ id: id }, input)), _jsx(StyledLabelCheckbox, __assign({ htmlFor: id }, { children: label }))] })));
        } })));
};
