...
function Input(_a) {
    ...
    return (_jsx(Field, __assign({}, restProps, { children: function (_a) {
            ...
            return (_jsx(StyledInput, __assign({ as: rows ? 'textarea' : 'input', rows: rows, hasError: meta.error && meta.touched, id: input.name, placeholder: placeholder, type: type }, input)));
        } })));
}
