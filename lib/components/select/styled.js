...
import { heights } from 'config/sizes';
...
export var SelectOption = styled.li(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  list-style: none;\n  border-radius: 4px;\n  background-color: ", ";\n  padding: 8px;\n  &:hover {\n    background-color: #ffff;\n  }\n"], ["\n  list-style: none;\n  border-radius: 4px;\n  background-color: ", ";\n  padding: 8px;\n  &:hover {\n    background-color: #ffff;\n  }\n"])), function (pr) {
    return pr.selected ? 'rgba(144, 202, 249, 0.13)' : '#EEEEEE';
});
export var StyledSelectDiv = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 100%;\n  padding: 8px;\n  border-radius: 8px;\n  transition: 0.1s ease-out;\n  box-shadow: inset 0 0 0 2px ", ";\n  background-color: #eeeeee;\n  height: ", "px;\n  &:focus {\n    box-shadow: inset 0 0 0 2px ", ";\n  }\n\n  //Disabled\n  ", "\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 100%;\n  padding: 8px;\n  border-radius: 8px;\n  transition: 0.1s ease-out;\n  box-shadow: inset 0 0 0 2px ", ";\n  background-color: #eeeeee;\n  height: ", "px;\n  &:focus {\n    box-shadow: inset 0 0 0 2px ", ";\n  }\n\n  //Disabled\n  ", "\n"])), function (pr) { return (pr.error ? '#d93848' : 'transparent'); }, function (pr) { return heights[pr.innerSize]; }, function (pr) { return (pr.error ? '#d93848' : '#000'); }, function (pr) {
    return pr.disabled &&
        "\n        background-color: #a6a6a6;\n        color: #5e5e5e;\n        cursor: not-allowed;\n\n        &:hover {\n            background-color: #a6a6a6 !important;\n            color: #5e5e5e !important;\n        }\n    ";
});
export var SelectOptionWrapper = styled.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  background-color: rgba(144, 202, 249, 0.16);\n  max-height: 240px;\n  &:hover {\n    cursor: pointer;\n  }\n"], ["\n  background-color: rgba(144, 202, 249, 0.16);\n  max-height: 240px;\n  &:hover {\n    cursor: pointer;\n  }\n"])));
