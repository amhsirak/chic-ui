    ...
    var showSelectedOptionValue = function () {
        if (!multiSelect) {
            ...
            return ((selectedOption &&
                ...
                selectedOption.map(function (option) { return (_jsxs(MultiSelectOptionWrapper, { children: [dataKey && dataName ? option[dataName] : option, _jsx(StyledCross, { onClick: function (e) {
                                e.stopPropagation;
    ...
    return (_jsxs(SelectWrapper, __assign({ ref: ref, className: className, width: width }, { children: [_jsxs(StyledSelectDiv, __assign({ tabIndex: disabled ? undefined : 0, disabled: disabled || false, error: error || false, innerSize: size, onClick: function () { return !disabled && setShowOptions(!showOptions); } }, { children: [_jsx("div", { children: showSelectedOptionValue() }, void 0), _jsx(ArrowDown, {}, void 0)] }), void 0), showOptions && (_jsx(SelectOptionWrapper, { children: _jsx("ul", { children: data &&
                        data.map(function (option, index) { return (_jsx(SelectOption, __assign({ selected: multiSelect &&
                                ...
                                (dataKey && dataName
                                    ...
                                    : selectedOption.includes(option)), onClick: function (e) {
                                e.stopPropagation;
                                onOptionSelect(dataKey ? option[dataKey] : option);
                            } }, { children: dataKey && dataName ? option[dataName] : option }), option + "_" + index)); }) }, void 0) }, void 0))] }), void 0));
};
