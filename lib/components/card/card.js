...
export var Card = function (props, ref) {
    var className = props.className, href = props.href, src = props.src, title = props.title, subTitle = props.subTitle, children = props.children, footer = props.footer, _a = props.hrefText, hrefText = _a === void 0 ? 'Link' : _a, description = props.description, style = props.style, _b = props.type, type = _b === void 0 ? 'light' : _b;
