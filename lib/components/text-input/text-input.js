...
var TextInput = function (props, ref) {
    ...
    return (_jsxs(StyledWrapper, __assign({ width: width, innerSize: size }, { children: [_jsx(StyledTextInput, __assign({ type: rest.type || 'text', value: value, onChange: onChange, readOnly: readonly, ref: ref, className: className, placeholder: placeholder }, styles, rest)), _jsx(StyledIcon, { as: icon, innerSize: size }), clearable && value ? (_jsx(StyledCross, { innerSize: size, onClick: function () {
