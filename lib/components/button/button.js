...
var Button = function (props, ref) {
    var _a = props.type, type = _a === void 0 ? 'primary' : _a, icon = props.icon, _b = props.size, size = _b === void 0 ? 'default' : _b, className = props.className, children = props.children, _c = props.disabled, disabled = _c === void 0 ? false : _c, _d = props.loading, loading = _d === void 0 ? false : _d, onClick = props.onClick, href = props.href, as = props.as, to = props.to, _e = props.search, search = _e === void 0 ? false : _e;
    var styles = {
        innerType: type,
        size: size,
        disabled: disabled,
    ...
    return (_jsx(StyledButton, __assign({ as: "button", type: "button", onClick: onClick, ref: ref, className: className }, styles, { children: loading ? (_jsxs(_Fragment, { children: ["Loading", _jsx(Spinner, __assign({}, spinnerStyles), void 0)] }, void 0)) : (childrenWithIcon) }), void 0));
};
