...
export var StyledButton = styled.button(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    font-size: 15px;\n    border: none;\n    border-radius: 8px;\n    outline: none;\n    cursor: pointer;\n    padding: 0 ", "px;\n    height: ", "px;\n    background-color: ", ";\n    color: ", ";\n    &:hover {\n        background-color: ", ";\n    }\n    &:focus {\n        box-shadow: 0 0 0 1px #fff, 0 0 0 2px ", ";\n    }\n\n    // Add margin for icon and loading\n    & > *:nth-child(1) {\n        margin-left: ", "px;\n    }\n\n    // Disabled button logic\n    ", "\n"], ["\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    font-size: 15px;\n    border: none;\n    border-radius: 8px;\n    outline: none;\n    cursor: pointer;\n    padding: 0 ", "px;\n    height: ", "px;\n    background-color: ", ";\n    color: ", ";\n    &:hover {\n        background-color: ", ";\n    }\n    &:focus {\n        box-shadow: 0 0 0 1px #fff, 0 0 0 2px ", ";\n    }\n\n    // Add margin for icon and loading\n    & > *:nth-child(1) {\n        margin-left: ", "px;\n    }\n\n    // Disabled button logic\n    ", "\n"])), function (pr) { return sidePaddings[pr.size]; }, function (pr) { return heights[pr.size]; }, function (pr) { return typeColors[pr.innerType].regular; }, function (pr) { return pr.innerType === 'light'
    ? '#000'
    : '#fff'; }, function (pr) { return typeColors[pr.innerType].hover; }, function (pr) { return typeColors[pr.innerType].regular; }, function (pr) { return pr.withText ? 7 : 0; }, function (pr) { return pr.disabled ? "\n        background-color: #a6a6a6;\n        color: #5e5e5e;\n        cursor: not-allowed;\n\n        &:hover {\n            background-color: #a6a6a6 !important;\n            color: #5e5e5e !important;\n        }\n        " : ''; });
