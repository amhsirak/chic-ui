...
export type SwitchType = 'default' | 'secondary' | 'danger' | 'warning' | 'success';
...
export const Switch: React.ForwardRefRenderFunction<HTMLInputElement, SwitchProps> = (props, ref) => {
    const {
        size = 'default',
        type = 'default',
        padding = 'default',
